...
- **`out`** : the parameter passed **can be** modified in the method + **not required to be initialized** before being passed in a method call

- **`ref`** : the parameter passed **can be** modified in the method + **must be initialized** before being passed in a method call


#### remark: 
||must be intialized?|Can be modified?|
|-|-|-|
|**`in`**|**T**|**F**|
|**`out`**|**F**|**T**|
|**`ref`**|**T**|**T**|
